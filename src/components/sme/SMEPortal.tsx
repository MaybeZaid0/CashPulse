...
import { Activity, ShieldCheck, User, History, CreditCard, Clock, LogOut } from "lucide-react";
              ...
              {selectedSme ? (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1.5 px-3 py-1.5 bg-slate-900 hover:bg-red-950/40 text-slate-300 hover:text-red-400 border border-slate-800 hover:border-red-900/50 rounded-xl text-xs font-bold transition-all cursor-pointer"
                  >
