        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            <div className="bg-[#0f2e3d] p-3 rounded-xl border border-[#1a4457]">
              <span className="text-[11px] text-[#9CA9A3] font-medium flex items-center space-x-1">
            ...
            <div className="bg-[#0f2e3d] p-3 rounded-xl border border-[#1a4457] col-span-2 sm:col-span-1">
              <span className="text-[11px] text-[#9CA9A3] font-medium flex items-center space-x-1">
                <ArrowDownRight className="w-3.5 h-3.5 text-[#E0453D]" />
                <span>Avg Monthly Money Out</span>
              </span>
              <span className="text-base font-extrabold text-[#E0453D] mt-1 block">
      ...
      <div className="bg-white rounded-2xl p-6 border border-[#E5E7EB] shadow-sm space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[#E5E7EB] pb-3 gap-2">
          ...
          <div className="flex items-center space-x-4 text-xs font-semibold">
            ...
            <div className="flex items-center space-x-1.5">
              <span className="w-3 h-3 rounded-full bg-[#E0453D] inline-block"></span>
