      ...
      <div className="bg-[#012A4A] text-white rounded-2xl p-6 shadow-xl border border-slate-800 space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="bg-[#0f2e3d] p-3 rounded-xl border border-[#1a4457]">
            <span className="text-[11px] text-[#9CA9A3] block">Total Pipeline Value</span>
          ...
          <div className="bg-[#0f2e3d] p-3 rounded-xl border border-[#1a4457]">
            <span className="text-[11px] text-[#9CA9A3] block">Pending Reviews</span>
            <span className="text-lg font-bold text-[#2F96B4]">{pendingCount}</span>
          </div>

          <div className="bg-[#0f2e3d] p-3 rounded-xl border border-[#1a4457]">
            <span className="text-[11px] text-[#9CA9A3] block">Assessed & Approved</span>
            <span className="text-lg font-bold text-[#2F96B4]">{approvedCount}</span>
          </div>

          <div className="bg-[#0f2e3d] p-3 rounded-xl border border-[#1a4457]">
            <span className="text-[11px] text-[#9CA9A3] block">Avg Turnaround Time</span>
