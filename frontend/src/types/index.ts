...
export interface ScoreEngineResult {
  ...
  loanStatus: 'APPROVED' | 'COUNTER-OFFER' | 'REJECTED';
...
export interface LoanApplication {
  ...
  tenureMonths: number;
  purpose: string;
  status: 'PENDING' | 'ASSESSED' | 'APPROVED' | 'COUNTER_OFFER' | 'MANUAL_REVIEW' | 'REJECTED';
  submittedAt: string;
  assessedAt?: string;
...
export interface FinancingApplication {
  ...
  recommendedLimit?: number;
  monthlyInstallment?: number;
  status: 'PENDING' | 'ASSESSED' | 'APPROVED' | 'APPROVED_DISBURSED' | 'COUNTER_OFFER' | 'COUNTER_OFFER_ISSUED' | 'COUNTER-OFFER' | 'MANUAL_REVIEW' | 'REJECTED';
  submittedAt: string;
  assessedAt?: string;
  assessment?: ScoreEngineResult | AssessmentResult;
